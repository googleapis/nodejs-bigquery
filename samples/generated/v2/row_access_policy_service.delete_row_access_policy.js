...
function main(projectId, datasetId, tableId, policyId) {
  // [START bigquery_v2_generated_RowAccessPolicyService_DeleteRowAccessPolicy_async]
  /**
  ...
  async function callDeleteRowAccessPolicy() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const response = await bigqueryClient.deleteRowAccessPolicy(request);
    console.log(response);
  }

  callDeleteRowAccessPolicy();
  // [END bigquery_v2_generated_RowAccessPolicyService_DeleteRowAccessPolicy_async]
}
