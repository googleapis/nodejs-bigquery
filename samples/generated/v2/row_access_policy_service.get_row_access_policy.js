...
function main(projectId, datasetId, tableId, policyId) {
  // [START bigquery_v2_generated_RowAccessPolicyService_GetRowAccessPolicy_async]
  /**
  ...
  async function callGetRowAccessPolicy() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const response = await bigqueryClient.getRowAccessPolicy(request);
    console.log(response);
  }

  callGetRowAccessPolicy();
  // [END bigquery_v2_generated_RowAccessPolicyService_GetRowAccessPolicy_async]
}
