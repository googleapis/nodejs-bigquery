...
function main(projectId, datasetId, tableId, rowAccessPolicy) {
  // [START bigquery_v2_generated_RowAccessPolicyService_CreateRowAccessPolicy_async]
  /**
  ...
  async function callCreateRowAccessPolicy() {
    // Construct request
    const request = {
      projectId,
      datasetId,
    ...
    // Run request
    const response = await bigqueryClient.createRowAccessPolicy(request);
    console.log(response);
  }

  callCreateRowAccessPolicy();
  // [END bigquery_v2_generated_RowAccessPolicyService_CreateRowAccessPolicy_async]
}
