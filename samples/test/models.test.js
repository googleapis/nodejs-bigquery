...
describe('Models', () => {
  const datasetId = `nodejs_samples_tests_models_${uuid.v4()}`.replace(/-/gi, '_');
  const modelId = `nodejs_samples_tests_models_${uuid.v4()}`.replace(/-/gi, '_');
...
describe('Delete Model', () => {
  const datasetId = `nodejs_samples_tests_models_delete_${uuid.v4()}`.replace(/-/gi, '_');
  const modelId = `nodejs_samples_tests_models_delete_${uuid.v4()}`.replace(/-/gi, '_');
