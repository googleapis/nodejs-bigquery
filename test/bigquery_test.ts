...
describe('BigQueryClient has the number of clients and methods we expect', () => {
  ...
  // this will need to manually be updated when new methods are added.
  // New tests should also be added for the new methods
  it('should have 46 methods including the constructor', () => {
    const client = new BigQueryClient();
    try {
      assert.equal(
...
describe('BigQueryClient handwritten methods work as expected', () => {
  it('exampleMethod works as expected', () => {
    const client = new BigQueryClient();
    assert.deepStrictEqual(client.exampleMethod(), 'BigQuery!');
  });
});
...
describe('BigQueryClient autogenerated methods work as expected', () => {
  describe('BigQueryClient should be able to handle passing in clients and options', () => {
    let subOptions: BigQueryClientOptions = {
      universeDomain: 'fake-universe-domain',
    };
    it('creates a central client using clients we pass in', () => {
      const datasetClient = new DatasetServiceClient(subOptions);
      const tableClient = new TableServiceClient(subOptions);
      const jobClient = new JobServiceClient(subOptions);
      const routineClient = new RoutineServiceClient(subOptions);
      const modelClient = new ModelServiceClient(subOptions);
    ...
    describe('BigQuery client should call underlying methods in the Dataset Client', () => {
      ...
      it('should call insertDataset', () => {
        ...
        const insertStub = sinon
          .stub(client.datasetClient, 'insertDataset')
          .callsArgWith(2, null, 'FakeDataset');
        const resp = client.insertDataset(
          datasetRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call listDatasets', () => {
        ...
        const resp = client.listDatasets(
          datasetRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call patchDataset', () => {
        ...
        const patchStub = sinon
          .stub(client.datasetClient, 'patchDataset')
          .callsArgWith(2, null, 'FakeDataset');
        const resp = client.patchDataset(
          datasetRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call updateDataset', () => {
        ...
        const updateStub = sinon
          .stub(client.datasetClient, 'updateDataset')
          .callsArgWith(2, null, 'FakeDataset');
        const resp = client.updateDataset(
          datasetRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call deleteDataset', () => {
        ...
        const deleteStub = sinon
          .stub(client.datasetClient, 'deleteDataset')
          .callsArgWith(2, null, 'FakeDataset');
        const resp = client.deleteDataset(
          datasetRequest,
          {},
          (err, response) => {
            if (err) {
    ...
    describe('BigQuery client should call underlying methods in the Routine Client', () => {
      ...
      it('should call insertRoutine', () => {
        ...
        const insertStub = sinon
          .stub(client.routineClient, 'insertRoutine')
          .callsArgWith(2, null, 'FakeRoutine');
        const resp = client.insertRoutine(
          routineRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call updateRoutine', () => {
        ...
        const updateStub = sinon
          .stub(client.routineClient, 'updateRoutine')
          .callsArgWith(2, null, 'FakeRoutine');
        const resp = client.updateRoutine(
          routineRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call patchRoutine', () => {
        ...
        const patchStub = sinon
          .stub(client.routineClient, 'patchRoutine')
          .callsArgWith(2, null, 'FakeRoutine');
        const resp = client.patchRoutine(
          routineRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call deleteRoutine', () => {
        ...
        const deleteStub = sinon
          .stub(client.routineClient, 'deleteRoutine')
          .callsArgWith(2, null, 'FakeRoutine');
        const resp = client.deleteRoutine(
          routineRequest,
          {},
          (err, response) => {
            if (err) {
      ...
      it('should call listRoutines', () => {
        ...
        const listStub = sinon
          .stub(client.routineClient, 'listRoutines')
          .callsArgWith(2, null, 'FakeRoutine');
        const resp = client.listRoutines(
          routineRequest,
          {},
          (err, response) => {
            if (err) {
