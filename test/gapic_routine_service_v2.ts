...
describe('v2.RoutineServiceClient', () => {
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          routineserviceModule.v2.RoutineServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          routineserviceModule.v2.RoutineServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'bigquery.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new routineserviceModule.v2.RoutineServiceClient({
          universe_domain: 'example.com',
  ...
  describe('getRoutine', () => {
    it('invokes getRoutine without error', async () => {
      ...
      const actualRequest = (
        client.innerApiCalls.getRoutine as SinonStub
      ).getCall(0).args[0];
  ...
  describe('insertRoutine', () => {
    it('invokes insertRoutine without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.insertRoutine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.insertRoutine as SinonStub
  ...
  describe('updateRoutine', () => {
    it('invokes updateRoutine without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.updateRoutine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.updateRoutine as SinonStub
  ...
  describe('deleteRoutine', () => {
    it('invokes deleteRoutine without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.deleteRoutine as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.deleteRoutine as SinonStub
  ...
  describe('listRoutines', () => {
    it('invokes listRoutines without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.listRoutines as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.listRoutines as SinonStub
    ...
    it('invokes listRoutines without error using callback', async () => {
      ...
      client.innerApiCalls.listRoutines =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.listRoutines(
          request,
    ...
    it('invokes listRoutinesStream without error', async () => {
      ...
      client.descriptors.page.listRoutines.createStream =
    ...
    it('uses async iteration with listRoutines without error', async () => {
      ...
      client.descriptors.page.listRoutines.asyncIterate =
