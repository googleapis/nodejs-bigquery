...
describe('v2.DatasetServiceClient', () => {
  ...
  describe('Common methods', () => {
    ...
    if (
      ...
      it('throws DeprecationWarning if static servicePath is used', () => {
        ...
        const servicePath =
          datasetserviceModule.v2.DatasetServiceClient.servicePath;
      ...
      it('throws DeprecationWarning if static apiEndpoint is used', () => {
        const stub = sinon.stub(process, 'emitWarning');
        const apiEndpoint =
          datasetserviceModule.v2.DatasetServiceClient.apiEndpoint;
        assert.strictEqual(apiEndpoint, 'bigquery.googleapis.com');
        assert(stub.called);
        stub.restore();
      });
    ...
    it('does not allow setting both universeDomain and universe_domain', () => {
      assert.throws(() => {
        new datasetserviceModule.v2.DatasetServiceClient({
          universe_domain: 'example.com',
    ...
    it('invokes getDataset without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getDataset(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.v2.IDataset | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('insertDataset', () => {
    it('invokes insertDataset without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.insertDataset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.insertDataset as SinonStub
    ...
    it('invokes insertDataset without error using callback', async () => {
      ...
      client.innerApiCalls.insertDataset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes insertDataset with error', async () => {
      ...
      const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.insertDataset = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('patchDataset', () => {
    it('invokes patchDataset without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.patchDataset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.patchDataset as SinonStub
    ...
    it('invokes patchDataset without error using callback', async () => {
      ...
      client.innerApiCalls.patchDataset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
        client.patchDataset(
          request,
    ...
    it('invokes patchDataset with error', async () => {
      ...
      const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? ''}&dataset_id=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.patchDataset = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('undeleteDataset', () => {
    it('invokes undeleteDataset without error', async () => {
      ...
      assert.deepStrictEqual(response, expectedResponse);
      const actualRequest = (
        client.innerApiCalls.undeleteDataset as SinonStub
      ).getCall(0).args[0];
      assert.deepStrictEqual(actualRequest, request);
      const actualHeaderRequestParams = (
        client.innerApiCalls.undeleteDataset as SinonStub
    ...
    it('invokes undeleteDataset without error using callback', async () => {
      ...
      client.innerApiCalls.undeleteDataset =
        stubSimpleCallWithCallback(expectedResponse);
      const promise = new Promise((resolve, reject) => {
    ...
    it('invokes undeleteDataset with error', async () => {
      ...
      const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? ''}&dataset_id=${defaultValue2 ?? ''}`;
      const expectedError = new Error('expected');
      client.innerApiCalls.undeleteDataset = stubSimpleCall(
        undefined,
        expectedError
      );
  ...
  describe('listDatasets', () => {
    it('invokes listDatasets without error', async () => {
      ...
      const expectedResponse = [
        generateSampleMessage(
          new protos.google.cloud.bigquery.v2.ListFormatDataset()
        ),
        generateSampleMessage(
          new protos.google.cloud.bigquery.v2.ListFormatDataset()
        ),
    ...
    it('invokes listDatasets without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listDatasets(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.bigquery.v2.IListFormatDataset[] | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listDatasetsStream without error', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        ...
        stream.on(
          'data',
          (response: protos.google.cloud.bigquery.v2.ListFormatDataset) => {
