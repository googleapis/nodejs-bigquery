...
import * as tableserviceModule from '../src/index.js';
    ...
    describe('listTables', () => {
        it('invokes listTables without error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? '' }&dataset_id=${defaultValue2 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.bigquery.v2.ListFormatTable()),
              generateSampleMessage(new protos.google.cloud.bigquery.v2.ListFormatTable()),
              generateSampleMessage(new protos.google.cloud.bigquery.v2.ListFormatTable()),
            ];
        ...
        it('invokes listTables without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listTables(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.bigquery.v2.IListFormatTable[]|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
        ...
        it('invokes listTablesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.bigquery.v2.ListFormatTable) => {
