...
import * as modelserviceModule from '../src/index.js';
    ...
    describe('listModels', () => {
        it('invokes listModels without error', async () => {
            ...
            const expectedHeaderRequestParams = `project_id=${defaultValue1 ?? '' }&dataset_id=${defaultValue2 ?? '' }`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.bigquery.v2.Model()),
              generateSampleMessage(new protos.google.cloud.bigquery.v2.Model()),
              generateSampleMessage(new protos.google.cloud.bigquery.v2.Model()),
            ];
        ...
        it('invokes listModelsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.bigquery.v2.Model[] = [];
                stream.on('data', (response: protos.google.cloud.bigquery.v2.Model) => {
        ...
        it('uses async iteration with listModels without error', async () => {
            ...
            const responses: protos.google.cloud.bigquery.v2.IModel[] = [];
