...
import * as model_service_client_config from './model_service_client_config.json';
import fs from 'fs';
...
const gapicConfig = getJSON(
  path.join(dirname, 'model_service_client_config.json')
);
 ...
 */
  ...
  listModels(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.bigquery.v2.IModel>): void;
  listModels(
      request: protos.google.cloud.bigquery.v2.IListModelsRequest,
      callback: PaginationCallback<
          protos.google.cloud.bigquery.v2.IListModelsRequest,
