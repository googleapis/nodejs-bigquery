...
import * as table_service_client_config from './table_service_client_config.json';
import fs from 'fs';
...
const gapicConfig = getJSON(
  path.join(dirname, 'table_service_client_config.json')
);
...
export class TableServiceClient {
   ...
   *     const client = new TableServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
 ...
 */
  ...
  listTables(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.bigquery.v2.IListFormatTable>): void;
  listTables(
      request: protos.google.cloud.bigquery.v2.IListTablesRequest,
      callback: PaginationCallback<
          protos.google.cloud.bigquery.v2.IListTablesRequest,
