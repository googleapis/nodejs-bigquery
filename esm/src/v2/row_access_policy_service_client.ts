...
import * as row_access_policy_service_client_config from './row_access_policy_service_client_config.json';
import fs from 'fs';
...
const gapicConfig = getJSON(
  path.join(dirname, 'row_access_policy_service_client_config.json')
);
...
export class RowAccessPolicyServiceClient {
   ...
   *     const client = new RowAccessPolicyServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
