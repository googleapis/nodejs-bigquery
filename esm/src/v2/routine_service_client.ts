...
import * as routine_service_client_config from './routine_service_client_config.json';
import fs from 'fs';
...
const gapicConfig = getJSON(
  path.join(dirname, 'routine_service_client_config.json')
);
...
export class RoutineServiceClient {
   ...
   *     const client = new RoutineServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
  constructor(opts?: ClientOptions, gaxInstance?: typeof gax | typeof gax.fallback) {
    ...
    this.descriptors.page = {
      listRoutines:
          new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'routines')
    };
 ...
 */
  ...
  listRoutines(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.bigquery.v2.IRoutine>): void;
  listRoutines(
      request: protos.google.cloud.bigquery.v2.IListRoutinesRequest,
      callback: PaginationCallback<
          protos.google.cloud.bigquery.v2.IListRoutinesRequest,
