...
import * as project_service_client_config from './project_service_client_config.json';
import fs from 'fs';
...
const gapicConfig = getJSON(
  path.join(dirname, 'project_service_client_config.json')
);
...
export class ProjectServiceClient {
   ...
   *     const client = new ProjectServiceClient({fallback: 'rest'}, gax);
   *     ```
   */
