...
import * as job_service_client_config from './job_service_client_config.json';
import fs from 'fs';
...
const gapicConfig = getJSON(
  path.join(dirname, 'job_service_client_config.json')
);
 ...
 */
  ...
  listJobs(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.bigquery.v2.IListFormatJob>): void;
  listJobs(
      request: protos.google.cloud.bigquery.v2.IListJobsRequest,
      callback: PaginationCallback<
          protos.google.cloud.bigquery.v2.IListJobsRequest,
